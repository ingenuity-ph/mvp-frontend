  ...
  variants: {
    adjoined: {
      ...
      top: [
        ...
        // Input
        "[&_[data-slot=input-container]]:rounded-t-none",
        // Border
        "[&_[data-slot=input-container]]:border-t-0",
      ],
      right: [
        // Root
        "before:rounded-r-none after:rounded-r-none",
        // Input
        "[&_[data-slot=input-container]]:rounded-r-none",
        // Border
        "[&_[data-slot=input-container]]:border-r-0",
      ],
      bottom: [
        // Root
        "before:rounded-b-none after:rounded-b-none",
        // Input
        "[&_[data-slot=input-container]]:rounded-b-none",
        // Border
        "[&_[data-slot=input-container]]:border-b-0",
      ],
      left: [
        // Root
        "before:rounded-l-none after:rounded-l-none",
        // Input
        "[&_[data-slot=input-container]]:rounded-l-none",
        // Border
        "[&_[data-slot=input-container]]:border-l-0",
      ],
...
export function InputGroup({
  ...
  return (
    <span
      ...
      className={clsx(
        // Basic layout
        "relative isolate flex rounded-[var(--radius-control)]",
...
export const TextInput = forwardRef(function TextInput(
  ...
  return (
    <AriaTextField
      ...
      className={cn(className, root(), inputStyles({ adjoined }))}
...
export const SearchInput = forwardRef(function SearchInput(
  {
    ...
    onChange,
    ...props
  }: Omit<InputProps, "onSubmit" | "onChange"> &
  ...
  return (
    <SearchField
      ...
      {...mergeProps(
        { onSubmit, onChange, onBlur: props.onBlur, onClear },
        {
          onChange: fieldControl?.onChange,
          onBlur: fieldControl?.onBlur,
          onClear: () => {
